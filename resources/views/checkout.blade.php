      ...
      <div class="col-md-8 order-md-1">
        ...
        <form class="needs-validation" novalidate method="POST">
          ...
          <div class="row">
            ...
            <div class="col-md-6 mb-3">
              <label for="cc-number">Nº do Cartão</label>
              <input type="text" class="form-control" id="cc-number" placeholder="Nº Cartão" required name="cart.number">
              <div class="invalid-feedback">
          ...
          <div class="row">
            <div class="col-md-3 mb-3">
              ...
              <input type="text" class="form-control" id="cc-expiration" placeholder="Dt. Validade" required name="cart.validate">
              <div class="invalid-feedback">
            ...
            <div class="col-md-3 mb-3">
              ...
              <input type="text" class="form-control" id="cc-cvv" placeholder="Cód. de seg." required name="cart.cvv">
              <div class="invalid-feedback">
